...
receive any client requests in the specified timeout interval (see [the session-timeout element]({{site.baseurl}}/zk_config_ref/the_session_config_element/the_session_timeout_element)
