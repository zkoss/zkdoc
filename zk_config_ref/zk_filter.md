---
title: "ZK Filter"
description: "ZK Filter is a filter to post-process the output generated by other servlets, such as JSP pages, so that rich user interfaces can be added to existent servlets."
---
