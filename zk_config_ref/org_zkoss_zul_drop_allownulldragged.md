...
description: "org.zkoss.zul.drop.allowNullDragged: If the value is true, then the DropEvent will allow NULL Component without throwing an exception, which means the…"
---
