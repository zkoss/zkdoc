...
To change the URL pattern, please refer to [this library property]({{site.baseUrl}}/zk_config_ref/The_Library_Properties/org.zkoss.zkmax.au.websocket.WebSocketEndPoint.urlPattern).
