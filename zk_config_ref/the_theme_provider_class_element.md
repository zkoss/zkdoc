---
title: "The theme-provider-class Element"
description: "The theme-provider-class Element: It specifies the class to provide the theme (aka., a style sheet file) URI dynamically if you want to determine the…"
---
