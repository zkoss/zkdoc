...
```
- Line 2: The `name` attribute has to be **model** which means it's  [a template for `<listbox>` model](https://www.zkoss.org/wiki/ZK_Developer's_Reference/mvc/View/Template/Listbox_Template).
