...
![Download zip]({{site.baseurl}}/zk_essentials/images/ze-ch2-download-zip.png)
...
![Index]({{site.baseurl}}/zk_essentials/images/ze-ch2-index.png)
...
minimal configuration to run ZK and for its detail please refer to [ ZK Installation Guide \\ Create and Run Your First ZK Application Manually]({{site.baseurl}}/zk_installation_guide/create_and_run_your_first_zk_application_manually).
...
Refer to [ZK Configuration Reference/zk.xml]({{site.baseurl}}/zk_config_ref/zk_xml) for more detail.
