...
![App]({{site.baseurl}}/zk_essentials/images/ze-ch6-app.png)

**Select a Todo Item**
![App selected]({{site.baseurl}}/zk_essentials/images/ze-ch6-app-selected.png)
...
Type item name in upper-left textbox and click ![Plus]({{site.baseurl}}/zk_essentials/images/ze-ch6-plus.png) or press "Enter" key to create a new todo item.
...
Click ![Cross]({{site.baseurl}}/zk_essentials/images/ze-ch6-cross.png) to delete an existing todo item.
