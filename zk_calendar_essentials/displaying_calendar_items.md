...
time** at an item's header: ![Calendar item](/zk_calendar_essentials/images/Calendar-item.png)

If an item is shorter than half an hour, it appends the content in the
header:

![Calendar item halfhour](/zk_calendar_essentials/images/Calendar-item-halfhour.png)
