...
[Google NotebookLM](https://notebooklm.google.com/) is an AI-powered research assistant that understands and reasons over your uploaded sources. Unlike general-purpose chatbots that rely on broad internet knowledge, NotebookLM grounds its answers specifically in the materials you provide, ensuring accurate, source-cited responses.
...
**Access the ZK Learning Notebook:**
[ZK Framework Learning Notebook: Docs, Code, Video](https://notebooklm.google.com/notebook/76ab4064-eefa-4cf6-ba64-5d80fb8be146)
...
- Recent Video from [ZK Framework YouTube channel](https://www.youtube.com/@zkframework3895/videos)
- Code examples
...
Visit [notebooklm.google.com](https://notebooklm.google.com/) and sign in with your Google account. NotebookLM is free to use.
...
1. **Browse the public notebook** - Explore pre-generated materials and ask questions:
   [ZK Framework Learning Notebook](https://notebooklm.google.com/notebook/76ab4064-eefa-4cf6-ba64-5d80fb8be146)
2. **Create your own notebook** - Build a personalized learning environment with your own sources
3. **Continue with traditional documentation** - Proceed to [Get ZK Up and Running with MVC]({{site.baseurl}}/get_started/get_zk_up_and_running_with_mvc) or [Get ZK Up and Running with MVVM]({{site.baseurl}}/get_started/get_zk_up_and_running_with_mvvm)
