...
![](images/demo_button.png)
![](images/download_button.png)

# Highlighted Features

![](images/highlighted_features.png)
...
![](images/stateful_component_overview.jpg)
...
![](images/server_mvvm.png)

![](images/client_mvvm.png)
...
{% include edition-availability.html edition="ce" %} ![](images/zk_linter.png "Zk_linter.png") Upgrading from
...
![](images/enhanced_security_framework.png)
...
{% include edition-availability.html edition="ce" %}
![](images/strict_get_post_handling.png "Strict-get-post-handling.png")
...
![](images/inaccessiblewidgetblockservice.png "InaccessibleWidgetBlockService.png")
