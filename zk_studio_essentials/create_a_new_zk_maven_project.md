...
![Studio maven plugin](images/studio-maven-plugin.png)
...
"Next \>". ![Studio maven project wizard](images/studio-maven-project-wizard.png)

2\. Select location. We usually use default workspace location. ![Studio maven project wizard 2](images/studio-maven-project-wizard-2.png)

3\. Enter "zk" in filter to search ZK maven archetypes and select what
you want. Click **Next**. ![Studio maven archetype](images/studio-maven-archetype.png)
...
**Finish**. ![Studio maven archetype parameter](images/studio-maven-archetype-parameter.png)

5\. The new ZK maven project is created with ZK dependencies added. ![Studio maven project](images/studio-maven-project.png)

# Run ZK Maven Project

1\. Right click on your project icon and select **\[Run as\]/\[Maven
build...\]** to open run configuration dialog. ![Studio maven run](images/studio-maven-run.png)

2\. Enter **jetty:run** in **Goals** textbox and click **Run**. ![Studio maven run jetty](images/studio-maven-run-jetty.png)
...
![Studio maven run console](images/studio-maven-run-console.png)
