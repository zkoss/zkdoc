...
4.  Click on the "Downloaded" tab, followed by "Add Plugins" to open the
    file explore  
    ![ZKInstallation Guide Net Beans Add Plugins](images/ZKInstallationGuide_NetBeans_AddPlugins.png)  
...
6.  Click "Install" and follow the NetBeans plugin manager prompts  
    ![ZKInstallation Guide Net Beans Install Plugin](images/ZKInstallationGuide_NetBeans_InstallPlugin.png)  
...
2.  On the New Project wizard under "Categories", select "Java Web"  
    ![ZKInstallation Guide Net Beans Select New ZKProject](images/ZKInstallationGuide_NetBeans_SelectNewZKProject.png)  
      
3.  Confirm and create a new ZK project.  
    ![ZKInstallation Guide Net Beans Create New ZKProject](images/ZKInstallationGuide_NetBeans_CreateNewZKProject.png)  
      
4.  Select the ZK project folder, and right click "Run" to deploy the
    project on Glassfish  
    ![ZKInstallation Guide Net Beans Run ZKProject](images/ZKInstallationGuide_NetBeans_RunZKProject.png)  
...
4.  Select the ZK demo project and right click to select "Run" to deploy
    the ZK demo  
    ![ZKInstallation Guide Net Beans Run ZKDemo](images/ZKInstallationGuide_NetBeans_RunZKDemo.png)  
