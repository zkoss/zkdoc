...
| Assignment | = | {% include supported-since.html version="8.0.0" %}<br>Assigns a value to a variable. |
| Semicolon | ; | {% include supported-since.html version="8.0.0" %}<br>Evaluates multiple expressions and returns the result of the last one. |
