...
| Name | Event Type |
|---|---|
| onPortalDrop | {% include supported-since.html version="9.5.1" %} **Event:** [org.zkoss.zkmax.ui.event.PortalDropEvent](https://www.zkoss.org/javadoc/latest/zk/org/zkoss/zkmax/ui/event/PortalDropEvent.html) Represents an event after a portal is dropped and before a portal is moved. |
