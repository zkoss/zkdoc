...
![Zk meetrpoblem01](/zk_dev_ref/images/zk_meetrpoblem01.png)
...
![Chrome js error](/zk_dev_ref/images/chrome_js_error.png)
...
3.  Send request details as HAR to us
    ...
    ![Save har chrome](/zk_dev_ref/images/save_har_chrome.png)

    2. Save request details as HAR in Firefox 
    ![Save har firefox](/zk_dev_ref/images/save_har_firefox.png)
...
![Au request](/zk_dev_ref/images/au_request.png)
...
context path: ![Jettyroot](/zk_dev_ref/images/jettyroot.png)

Click the link and it will list folders then you can navigate to find
the zul. ![Listfolder](/zk_dev_ref/images/listfolder.png)
