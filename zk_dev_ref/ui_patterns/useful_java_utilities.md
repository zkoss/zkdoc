...
{% include supported-since.html version="9.6.0" %}To handle javascript errors triggered
by evalJavascript,
...
[Clients.showNotification()](http://www.zkoss.org/javadoc/latest/zk/org/zkoss/zk/ui/util/Clients.html#showNotification-java.lang.String) {% include supported-since.html version="9.0.0" %} It is
...
{% include supported-since.html version="6.5.0" %} Notification now supports closable to
...
{% include edition-availability.html edition="ee" %} {% include supported-since.html version="9.0.0" %}
