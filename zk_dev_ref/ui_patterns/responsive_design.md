...
You can adjust the component size using either [ *vflex* or *hflex*]({{site.baseurl}}/zk_dev_ref/ui_patterns/hflex_and_vflex)
...
The adaptive layout is more advantageous than [ Fluid Layouts](#Fluid_Layouts), the problem we met in the fluid
...
can solve this by using [CSS 3 Media Query](http://www.w3.org/TR/css3-mediaqueries/).
...
apply the same concepts mentioned in [ Adaptive Layouts](#Adaptive_Layouts), with *@Media Query* to fine tune
...
**Note:** Some of the components and features used above are [available in ZK EE only](http://www.zkoss.org/product/edition.dsp).
