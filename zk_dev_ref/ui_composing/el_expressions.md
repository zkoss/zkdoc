...
- [Implicit objects](/zuml_ref/implicit_objects__predefinedvariables_)
- Scoped attributes
...
Then, you can use them by specifying it in a [taglib directive](/zuml_ref/taglib).
