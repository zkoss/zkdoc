...
By default, zk generates UUID in a random pattern. But if you want a predictable UUID pattern e.g. for automated testing purpose, please see [Testing Tips](../testing/testing_tips)
...
- **How can I make UUIDs static for testing?**
  - See [Testing Tips](../testing/testing_tips) for configuring predictable UUIDs.
