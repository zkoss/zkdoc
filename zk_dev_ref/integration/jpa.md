...
![Icon info]({{site.baseurl}}/zk_dev_ref/images/icon_info.png) **Note:** If you don't use Maven,
...
![Hibernate beginning]({{site.baseurl}}/zk_dev_ref/images/hibernate-beginning.png)
