...
This section walks through setting up the ZK Spring Integration Library
and provides a brief overview of ZK Spring essentials. You can install
ZK Spring either by copying JAR files into an existing project or by
building a Maven project. Choose whichever fits your workflow below.
...
- Copy the downloaded ZK, Spring, and ZK Spring jar files into your web
...
Then continue to [Configuring web.xml](#configuring-webxml) below.
...
Whichever installation method you use, you need to declare Spring
`ContextLoaderListener` in the `web.xml` file to be able to declare and
register your Spring beans with Spring framework.
